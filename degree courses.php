...
<body>
	...
	<div class="minner_page_mainsmk minner_page_mainsmk_2">
		<h3 class="mtittle">Degree Courses</h3>
	...
	<div class="mcontent-course">
		<div class="container">
			...
			<div class="col-sm-12 mmain-right-textmk-content" id="intro">
				...
				<div class="row">
					<div class="col-md-6"><a href="#"><img class="cimg" src="images (95).jpg" alt="" /></a></div>
          <div class="col-md-6"style="margin-top: 3vh;">
            <h2><strong>Degree courses</strong></h2>
            <p> Candidates must have 12 passes or equivalent or one must join any graduate course.Diploma holders in engineering are also eligible to graduate. But those candidates must have lived from a recognized institution. Except for these courses which satisfy the specific criteria of the candidate for many of them. Require a minimum age of 17 years with the above criteria. So it is not possible to join directly for engineering after 10th. </p>
          </div>
		  </li>
				</div>
				<!-- //introduction section -->
