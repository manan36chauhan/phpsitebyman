...
<?php include("header.html"); ?>
	...
	<div class="minner_page_mainsmk minner_page_mainsmk_2">
		<h3 class="mtittle">Master of Surgery</h3>
	...
	<div class="mcontent-course">
		<div class="container">
			...
			<div class="col-sm-12 mmain-right-textmk-content" id="intro">
				...
				<div class="row">
					<div class="col-md-6"><a href="#"><img class="cimg" src="ms1.jpg" alt="" /></a></div>
			<div class="col-md-6" style="margin-top: 3vh;">
			<h2><strong>Master of Surgery </strong></h2>
			<p>-->	These cells include cardiology, gynecology, neurology, neurology, or therapeutics for diseases, plastic surgery (thoracic operation), thoracic surgery (neck and abdominal tract surgery).</p>
			</div>
				</div>
				<!-- //introduction section -->
