...
<body>
	...
	<div class="minner_page_mainsmk minner_page_mainsmk_2">
		<h3 class="mtittle">Master of Architect</h3>
	...
	<div class="mcontent-course">
		<div class="container">
			...
			<div class="col-sm-12 mmain-right-textmk-content" id="intro">
				...
				<div class="row">
					<div class="col-md-6"><a href="#"><img class="cimg" src="barch4.jpg" alt="" /></a></div>
			<div class="col-md-6" style="margin-top: 3vh;">
				<h2><strong>M.A.R. (Master of Architecture) (2 years)</strong></h2>
				<p>-->With this course, careers can be made in landscape architecture, architectural conservation, urban designing, building design, housing (residential construction), transportation, regional planning, etc.</p>
			</div>
				</div>
				<!-- //introduction section -->
