...
<body>
	...
	<div class="minner_page_mainsmk minner_page_mainsmk_2">
		<h3 class="mtittle">Arts Stream</h3>
	...
	<div class="mcontent-course">
		<div class="container">
			...
			<div class="col-sm-12 mmain-right-textmk-content" id="intro">
				...
				<div class="row">
				<div class="col-md-6"><a href="#"><img class="cimg" src="arts11.jpeg" alt="" /></a></div>
		  <div class="col-md-6" style="margin-top: 3vh;">
		     <h2><strong>Arts Stream</strong></h2>
			 <p>
			-> Arts stream offers numerous career options and opportunities to students. It is a very traditional stream. This is one of the main reasons why this stream still has got takers in India! This stream is made up of parts like humanities, visual arts, performing arts, literary arts etc. In this article, you will be reading details about arts stream schooling (11th and 12th) such as- education boards available in India, important subjects to study, professional courses available after 12th, career paths and prospects.</p>
		   </div>
