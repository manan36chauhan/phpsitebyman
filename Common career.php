...
<body>
	...
	<div class="minner_page_mainsmk minner_page_mainsmk_2">
		<h3 class="mtittle">Common Career</h3>
	...
	<div class="mcontent-course">
		<div class="container">
			...
			<div class="col-sm-12 mmain-right-textmk-content" id="intro">
				...
				<div class="row">
					 <div class="col-md-6 "> <a href="#"><img class="cimg" src="bed1.jpg" alt="" /></a></div>
		<div class="col-md-6" style="margin-top: 3vh;">
		<h2><strong> Common Carrier (General Career)</strong></h2>
		<p>-> Hotel Management & Catering<br />
-> Industrial & Personal Management (Industrial & Personal)<br />
-> Travel & Tourism (Travel & Tourist Services)
</p>
		</div>
				</div>
				<!-- //introduction section -->
