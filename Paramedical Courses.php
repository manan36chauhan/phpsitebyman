...
<body>
	...
	<div class="minner_page_mainsmk minner_page_mainsmk_2">
		<h3 class="mtittle">Paramedical Course</h3>
	...
	<div class="mcontent-course">
		<div class="container">
			...
			<div class="col-sm-12 mmain-right-textmk-content" id="intro">
				...
				<div class="row">
					 <div class="col-md-6"><a href="#"><img class="cimg" src="pera1.jpg" alt="" /></a></div>
		<div class="col-md-6" style="margin-top: 3vh;">
		<h2><strong>Paramedical Courses</strong></h2>
		<p><br />The various medical cells are as follows:<br /><br />1)Medical Lab Technology 
2) Medical X-ray technology <br /><br />
3) Medical record technology<br /><br />
</p>
		</div>
				</div>
				<!-- //introduction section -->
