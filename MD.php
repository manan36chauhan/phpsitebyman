...
<body>
	...
	<div class="minner_page_mainsmk minner_page_mainsmk_2">
		<h3 class="mtittle">Doctor of Medicine</h3>
	...
	<div class="mcontent-course">
		<div class="container">
			...
			<div class="col-sm-12 mmain-right-textmk-content" id="intro">
				...
				<div class="row">
				<div class="col-md-6"><a href="#"><img class="cimg" src="md3.jpg" alt="" /></a></div>
			<div class="col-md-6" style="margin-top: 3vh;">
			<h2><strong>MD</strong></h2>
			<p> ->MD's full name is Doctor of Medicine. <br />
->This course is for 3 years <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-	Anesthesiologist (Internal Medicine)<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-	Pathology<br />
