...
<body>
	...
	<div class="minner_page_mainsmk minner_page_mainsmk_2">
		<h3 class="mtittle">Master in Fine Arts.</h3>
	...
	<div class="mcontent-course">
		<div class="container">
			...
			<div class="col-sm-12 mmain-right-textmk-content" id="intro">
				...
				<div class="row">
					<div class="col-md-6"><a href="#"><img class="cimg" src="fine1.jpg" alt="" /></a></div>
			<div class="col-md-6" style="margin-top: 3vh;">
			<h2><strong>MFA </strong></h2>
			<p>--> MFA's full name is Master in Fine Arts.<br />-> This is a 3 year course. 
			<br>-->MFA (Master of Fine Arts) is a postgraduate degree course that involves the study of visual and performing arts. The course is of two year duration (usually divided into four semesters) and most of the colleges or universities offer the course with a specialisation.
			</p>
			</div>
				</div>
				<!-- //introduction section -->
