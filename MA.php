...
<body>
	...
	<div class="minner_page_mainsmk minner_page_mainsmk_2">
		<h3 class="mtittle">Master of Arts</h3>
	...
	<div class="mcontent-course">
		<div class="container">
			...
			<div class="col-sm-12 mmain-right-textmk-content" id="intro">
				...
				<div class="row">
					 <div class="col-md-6"><br /><br /><br /><br /><br /><a href="#"><img class="cimg" class="cimg" src="ma4.jpg" alt="" /></a></div>
					<div class="col-md-6">
            <h2>M.A(Master in Arts)</h2>
            <p>-> two years course <br >You can Bachelor in the following topics<br /><br />1) Anthropology<br /><br />2)Economics
<br><br />3)history<br /><br />
4)Languages(Gujarati, English, Hindi, Sanskrit, Marathi, German, Russian)<br /><br />
5)Sociology<br /><br />
6) Geography<br /><br />
7)Philosophy <br /><br />
8)Political Science<br /><br />
9)Psychology (Psychology)<br /><br />
10)Public Administration<br /><br />
11)Statistics<br /><br />
</p>
