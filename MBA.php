...
<body>
	...
	<div class="minner_page_mainsmk minner_page_mainsmk_2">
		<h3 class="mtittle">Master of Business Administration</h3>
	...
	<div class="mcontent-course">
		<div class="container">
			...
			<div class="col-sm-12 mmain-right-textmk-content" id="intro">
				...
				<div class="row">
				<div class="col-md-6"><a href="#"><img class="cimg" src="bms3.jpg" alt="" /></a></div>
			<div class="col-md-6" style="margin-top: 3vh;">
				<h2><strong>MBA</strong></h2>
				<p>-> The full name of the MBA is Master of Business Administration.
				<br>-->TWO-year professional courses which is the ever demanding one in India.
				<br>-->MBA is an Internationally accepted master of post-graduate level degree. The core courses in an MBA program cover various areas of business such as accounting, finance, marketing, human resources, operations, and statistics and many.
			</p>
			</div>
					</div>
				<!-- //introduction section -->
