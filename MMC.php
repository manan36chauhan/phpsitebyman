...
<body>
	...
	<div class="minner_page_mainsmk minner_page_mainsmk_2">
		<h3 class="mtittle">Master in Mass Communication.</h3>
	...
	<div class="services-agile-breadcrumb">
		<div class="inner_breadcrumb">
			<ul class="short_ls">
				...
				<li>Master in Mass Communication.</li>
			</ul>
		</div>
	</div>
	<!-- //Page details -->
	...
	<div class="mcontent-course">
		<div class="container">
			...
			<div class="col-sm-12 mmain-right-textmk-content" id="intro">
				...
				<div class="row">
				<div class="col-md-6"><a href="#"><img class="cimg" src="mmc2.jpg" alt="" /></a></div>
			<div class="col-md-6" style="margin-top: 3vh;">
			<h2><strong>MMC</strong> </h2>
			<p>-> MMC's full name is Master in Mass Communication.</p>
			</div>
					</div>
				<!-- //introduction section -->
