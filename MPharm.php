...
<body>
	...
	<div class="minner_page_mainsmk minner_page_mainsmk_2">
		<h3 class="mtittle">Masters of Pharmacy</h3>
	...
	<div class="mcontent-course">
		<div class="container">
			...
			<div class="col-sm-12 mmain-right-textmk-content" id="intro">
				...
				<div class="row">
					<div class="col-md-6"><a href="#"><img class="cimg" src="mpharm1.jpg" alt="" /></a></div>
			<div class="col-md-6" style="margin-top: 3vh;">
			<h2><strong>M.Pharm</strong></h2>
			<p>The full name of this course is Master of Pharmacy. This cell is 3 years old. These courses include Medical Naturals Production and Pharmaceutical Chemistry, Pharmacognosy, Pharmaceutical Biotechnology (Pharmacology), Quality Assurance, Quality Assurance, and Quality Assurance. </p>
			</div>
			</li>
				</div>
				<!-- //introduction section -->
