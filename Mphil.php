...
<body>
	...
	<div class="minner_page_mainsmk minner_page_mainsmk_2">
		<h3 class="mtittle">Master of Philosophy</h3>
	...
	<div class="mcontent-course">
		<div class="container">
			...
			<div class="col-sm-12 mmain-right-textmk-content" id="intro">
				...
				<div class="row">
				<div class="col-md-6"><a href="#"><img class="cimg" src="mphil2.jpg" alt="" /></a></div>
			<div class="col-md-6" style="margin-top: 3vh;">
					<h2><strong>M.phil </strong></h2>
					<p>-> M.Phil's full name is Master in Philosophy.<br />
						->this course time duration is 1.5 year.<br />
						-> This course has a semester method.<br />
</p>
			</div>
