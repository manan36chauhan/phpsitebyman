...
<body>
	...
	<div class="minner_page_mainsmk minner_page_mainsmk_2">
		<h3 class="mtittle">Bachelor of Education</h3>
	...
	<div class="mcontent-course">
		<div class="container-fluid">
			...
			<div class="col-sm-12 mmain-right-textmk-content" id="intro">
				...
				<div class="row">
					<div class="col-md-6"><a href="#"><img class="cimg" src="bed2.jpg" alt="" /></a></div>
					<div class="col-md-6"style="margin-top: 3vh;">
						<h2><strong>B.ed </strong></h2>
						<p>-> this course time duration is 2 year.<br />
							->After completing this course the teacher's job can be found.<br /></p>
					</div>
