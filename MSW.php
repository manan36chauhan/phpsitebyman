...
<body>
	...
	<div class="minner_page_mainsmk minner_page_mainsmk_2">
		<h3 class="mtittle">Master of social works</h3>
	...
	<div class="mcontent-course">
		<div class="container">
			...
			<div class="col-sm-12 mmain-right-textmk-content" id="intro">
				...
				<div class="row">
				<div class="col-md-6"><a href="#"><img class="cimg" src="bsw1.jpg" alt="" /></a></div>
			<div class="col-md-6" style="margin-top: 3vh;">
			<h2><strong>MSW</strong>  </h2>
			<p>-> MSW's full name is Master in Social Work.
			<br>->MSW is a post-graduation course in the field of Social Work which is usually of two years duration. Aspirants can pursue MSW course after pursuing a Bachelor’s degree. Candidates who have pursued a Bachelor of Social Work (BSW) degree are preferred if they opt to pursue a post-graduation course in social work. The career in social work is all about giving and helping others in need. From various NGOs (non-government organisations) across the nation to social development, a master's in social work will provide a candidate an in-depth knowledge about the work put into the development of humanity and social welfare.
