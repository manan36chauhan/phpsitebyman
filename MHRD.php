...
<body>
	...
	<div class="minner_page_mainsmk minner_page_mainsmk_2">
		<h3 class="mtittle">Master in Human Resource Management</h3>
	...
	<div class="services-agile-breadcrumb">
		<div class="inner_breadcrumb">
			<ul class="short_ls">
				...
				<li>Master in Human Resource Management</li>
			</ul>
		</div>
	</div>
	<!-- //Page details -->
	...
	<div class="mcontent-course">
		<div class="container">
			...
			<div class="col-sm-12 mmain-right-textmk-content" id="intro">
				...
				<div class="col-md-6"><a href="#"><img class="cimg" src="barch3.jpg" alt="" /></a></div>
			<div class="col-md-6" style="margin-top: 3vh;">
			<h2><strong>MHRD</strong> </h2>
			<p>--> MHRD's full name is Master in Human Resource Management.<br />->This is a 3 year course.
			<br>-->A Master of Science in Human Resource Development (abbreviated HRD or MSHRD) is a type of postgraduate academic master's degree awarded by universities in many countries. This degree is typically studied for in Human Resource Development and Human Resource Management.
			</p>
			</div>
